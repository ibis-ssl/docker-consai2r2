...
class Metaclass_RobotCommands(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('consai2_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'consai2_msgs.msg.RobotCommands')
            logger.debug(
            ...
            from consai2_msgs.msg import RobotCommand
...
class RobotCommands(metaclass=Metaclass_RobotCommands):
    ...
    _fields_and_field_types = {
        ...
        'is_yellow': 'boolean',
        'commands': 'sequence<consai2_msgs/RobotCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['consai2_msgs', 'msg'], 'RobotCommand')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'commands' field must be a set or sequence and each value of type 'RobotCommand'"
