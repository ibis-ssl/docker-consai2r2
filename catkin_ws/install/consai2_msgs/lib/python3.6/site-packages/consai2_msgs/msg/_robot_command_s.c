...
bool consai2_msgs__msg__robot_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "consai2_msgs.msg._robot_command.RobotCommand",
        full_classname_dest, 44) == 0);
  }
  consai2_msgs__msg__RobotCommand * ros_message = _ros_message;
  {  // robot_id
...
PyObject * consai2_msgs__msg__robot_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("consai2_msgs.msg._robot_command");
  ...
  consai2_msgs__msg__RobotCommand * ros_message = (consai2_msgs__msg__RobotCommand *)raw_ros_message;
  {  // robot_id
    PyObject * field = NULL;
